...
## Environments
- Preview: https://main--cbalanescu-crexont--aemdemos.aem.page/
- Live: https://main--cbalanescu-crexont--aemdemos.aem.live/
...
1. Open the `cbalanescu-crexont` directory in your favorite IDE and start coding :)
